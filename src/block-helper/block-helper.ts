...
module.exports = {
     ...
     */
    createHomeViewHeaderBlocks: function (memberId: string): any[] {
        return [
            {
                "type": "section",
                "text": {
     ...
     * @returns An array of Block Kit blocks
     */
    createCollectionBookSpecificBlocks: function (collectionItem: CollectionItem, showInteractionOptions: boolean, pageNumber: number): any[] {
        ...
        if (showInteractionOptions) {
            actionElements.push(...[
                    ...
                    "options": [
                        {
                            ...
                            "value": [collectionItem.isbn, "0", pageNumber].join("|")
                        },
                        {
                            "text": {
                                "type": "plain_text",
                            ...
                            "value": [collectionItem.isbn, "1", pageNumber].join("|")
                        },
                        {
                            "text": {
                                "type": "plain_text",
                            ...
                            "value": [collectionItem.isbn, "2", pageNumber].join("|")
                        },
                        {
                            "text": {
                                "type": "plain_text",
                            ...
                            "value": [collectionItem.isbn, "3", pageNumber].join("|")
                        },
                        {
                            "text": {
                                "type": "plain_text",
                            ...
                            "value": [collectionItem.isbn, "4", pageNumber].join("|")
                        },
                        {
                            "text": {
                                "type": "plain_text",
                            ...
                            "value": [collectionItem.isbn, "5", pageNumber].join("|")
                        }
                    ],
                    ...
                    "options": [
                        {
                            ...
                            "value": [collectionItem.isbn, "false", pageNumber].join("|")
                        },
                        {
                            "text": {
                                "type": "plain_text",
                            ...
                            "value": [collectionItem.isbn, "true", pageNumber].join("|")
                        }
                    ],
                ...
                },
                {
                    ...
                    "style": "danger",
                    "value": [collectionItem.isbn, pageNumber].join("|"),
